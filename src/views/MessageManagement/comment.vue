<template>
  <div>
    ...
    <el-table :data="list" border style="width: 100%" height="410" v-loading="loading" element-loading-text="拼命加载中"  :header-cell-style="headClass" size="mini" >
      ...
      <el-table-column prop="toName" label="用户名" align="center"></el-table-column>
      <el-table-column prop="itemName" label="物品名称" align="center"></el-table-column>
      <el-table-column prop="commentTopic" label="评论内容" align="center"></el-table-column>
      <el-table-column prop="thumbsUp" label="点赞数" align="center"></el-table-column>
      ...
      <el-table-column prop="" label="操作" align="center" width="120">
          <template slot-scope="scope">
            <el-tooltip class="item" effect="dark" content="删除" placement="bottom">
                <el-button circle type="danger" icon="el-icon-delete" size="mini" @click="deleteComment(scope.row.id)"></el-button>
            </el-tooltip>
          </template>   
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
        this.loading = true
        this.$http.commentList(this.queryList).then( r =>{
          if( r.code === 10000) {
            this.loading = false
